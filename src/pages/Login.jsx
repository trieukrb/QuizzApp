...
import {auth, db} from '../firebaseConfig.js'; // Import `auth`
import {
    GoogleAuthProvider,
...
import {doc, getDoc, setDoc} from "firebase/firestore"; // Import hàm đăng nhập
...
const Login = () => {
    ...
    return (
        // <div className="w-screen h-screen bg-gradient-to-br from-violet-200 to-pink-200 flex justify-center items-center">
        <div className="relative w-screen h-screen bg-[url(/auth_bg.jpg)] bg-cover bg-center flex justify-center items-center">
                                ...
                                <>
                                    <form className="max-w-md mx-auto" onSubmit={handleSubmit}>
                                        ...
                                        {error === 'Firebase: Error (auth/invalid-credential).' ?
                                            <p className="mb-3 text-red-500 text-sm pl-2">Wrong email or password</p> : ''}
