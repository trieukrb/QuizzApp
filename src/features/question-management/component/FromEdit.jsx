...
const FromEdit = ({showfalse,
    ...
    return (
        <div className='fixed top-0 right-0 left-0 bottom-0 bg-neutral-500/30 flex justify-center items-center' onClick={showfalse}>
            <form action="" className="bg-neutral-100 p-5 rounded-xl  shadow-xl sm:min-w-100 md:min-w-120 lg:min-w-150 " onSubmit={handleSubmitEditForm} onClick={handlestopPropagation}>
