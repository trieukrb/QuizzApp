...
const HeaderAdd = ({searchTerm,setSearchTerm,setIsShowModelAdd}) => {
    return (
        <div className='flex flex-col md:flex-row items-center justify-between gap-3'>
            <label className="flex gap-2 items-center w-4/5  md:w-3/5 p-2 rounded-3xl shadow-sm border-2 border-neutral-300 placeholder:text-neutral-400" for='search-bar'>
